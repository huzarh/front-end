...
export default function voiceChat() {
  const [chat, setChat] = useState([{
    author:"r",
    text:"Merhaba, ben Ahmet. Senin adın ne?",
    correct:"0"
  }]);
...
const bot = [
  ...
  return (<div style={{background:"transparent",inset: "10px",padding: "0px",display: "flex",flexDirection: "column",flexWrap: "nowrap",height:"97vh",justifyContent:"space-between"}}>
    <div className="box" style={{display: "flex",flexDirection: "column"}}>
      {chat.map((e,i)=>(
       <div key={i} className="msg"  style={{borderRadius:"10px",background:"rgb(38, 39, 49)",color:"white",width:"70%",alignSelf:e.author === 'r' ? 'start':'end',marginBottom:"10px",padding:'10px',textJustify:"auto"}}>{e.text}</div>
      ))}
